...
namespace Data.Spider
{
    public class AtzucheEntitySpider:EntitySpider
    {
        ...
        {
            AddPipeline(new SqlServerEntityPipeline("Server=.\\sql2019;Database=AuzucheSpider;Trusted_Connection=True;MultipleActiveResultSets=true"));//注意连接字符串中数据库不能带 .  亲测报错。。。
